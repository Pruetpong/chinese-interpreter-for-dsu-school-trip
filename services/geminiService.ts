...
export function createChatSession(
    ...
    const systemInstruction = generateSystemPrompt(tab, interpreterId, scenarioId, userModeId);
        ...
        const response = await ai.models.generateContent({
            ...
            contents: {
                parts: [
                    ...
                    {
                        text: 'Transcribe the following audio spoken in either Thai or Chinese. Provide only the transcribed text.',
                    }
                ]
            },
        });
